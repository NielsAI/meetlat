...
**What normal looks like**: 0.00 per 1000 over the 28-paragraph clean corpus (366
words, zero hits), across all four registers. That is the number a checkpoint's score
